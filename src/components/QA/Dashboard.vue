<template>
  <div>
    ...
    <!--<div style="padding: 20px; text-align: left;">* 코멘토 앱을 참고하면서 앱을 만들다보니 '질문 & 답변' 페이지를-->
      <!--회의 때 얘기했던 UI와는 조금 다르게 구성해봤습니다.<br><br>-->
      <!--* 수정이 필요한 부분이나 기획했던 것과 다른 부분이 있으시면 말씀해주시기 바랍니다.-->
    <!--</div>-->
